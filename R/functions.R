...
#'
#' `canavg` computes points in the sky associated with all survey points on the surface of a concave hemispherical mirror densiometer and extracts insolation values for those points from a 'detailed report' generated by the software Gap Light Analyzer. It returns coefficients for weighted averaging of each of four separate measurements.
#'
#' @description
...
#' @param eyey The y-coordinate of the eye position. Default is -8.
#' @param eyez The z-coordinate of the eye position. Default is 10.
#' @param survmeth The survey method. Default is "card".
#' @param weightscalc Logical; if TRUE, computes weights for averaging. Default is TRUE.
#' @param diagnostics Logical; if TRUE, prints diagnostic information. Default is TRUE.
#'
#' @return A list of coefficients for weighted averaging of each of four separate measurements.
#' @export
#'
#' @examples
